...
\begin{document}
	...
	\section{Experience}
	\cventry{Aug 2015 -- present}{Senior Software Developer}{RTI International}{Durham, NC}{}{
		I work with a team of data scientists to build visualizations and analytical tools.
		\bigskip
		\begin{itemize}%
			\item Developed a dashboard used to track disease at the 2015 Kumbh Mela, one of the world's largest outdoor gatherings.
			\item Created an application to help law enforcement make their call for service (911) data visible and actionable.
		\end{itemize}
	}
	\bigskip	
