...
\begin{document}
	...
	\section{Summary}
	I am a senior developer and development manager with more than 21 years of experience, focusing on web development and data science.
	In addition to working as a developer, I have spent the last three years training career-changers to become software developers.

	\section{Skills}
	\cvitem{Expert}{Python, Django, JavaScript, React, SQL}
	\cvitem{Proficient}{Clojure, Perl, Flask, Ruby, CSS, API design}
	\cvitem{Competent}{Machine learning, Pandas, NumPy}
	\cvitem{Beginner}{\LaTeX, interpreters}
	\cvitem{Want to learn}{Go, compiler design}


	\section{Experience}
	\cventry{Oct 2017 -- present}{CTO and Lead Instructor}{Momentum}{Durham, NC}{}{
		Built curriculum and led instruction for a 16-week program to train career changers to become software developers using Python, Django, JavaScript, and React.
		\bigskip
		\begin{itemize}%
			\item Led instructional team, coordinating instruction across multiple phases.
			\item Graduated over 135 students with a 90\% job placement rate.
		\end{itemize}
	}
	\bigskip

	\cventry{May 2017 -- Oct 2017}{Curriculum Director}{The Iron Yard}{Durham, NC}{}{
		Directed curriculum development team of five curriculum authors.
	}
	\bigskip

	\cventry{Aug 2015 -- May 2017}{Software Development Manager}{RTI International}{Durham, NC}{}{
	...
	\cventry{Nov 2012 -- Apr 2014}{Technology Fellow}{Consumer Financial Protection Bureau}{\mbox{Washington, DC}}{}{
		...
		\begin{itemize}
			...
			\item Coordinated a major effort to open source over a dozen projects.
	...
	\cventry{July 2003 -- Aug 2005}{Development Manager}{ShowMaster Systems}{New Orleans, LA}{}{
